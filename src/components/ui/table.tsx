...
export const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(({ className, ...props }, ref) => <th ref={ref} className={cn("h-11 px-4 text-left align-middle text-xs font-semibold uppercase tracking-wider text-muted-foreground", className)} {...props} />);
...
[Table, TableHeader, TableBody, TableRow, TableHead, TableCell].forEach((component, index) => { component.displayName = ["Table", "TableHeader", "TableBody", "TableRow", "TableHead", "TableCell"][index]; });
