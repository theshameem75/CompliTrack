...
[Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter].forEach((component, index) => { component.displayName = ["Card", "CardHeader", "CardTitle", "CardDescription", "CardContent", "CardFooter"][index]; });
